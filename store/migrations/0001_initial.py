# Generated by Django 3.0.6 on 2021-02-26 18:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Ordered', 'Ordered'), ('Packed', 'Packed'), ('Shipped', 'Shipped'), ('Delivered', 'Delivered')], default='Ordered', max_length=128)),
                ('track', models.CharField(blank=True, default='Warehouse Jaipur, RJ', max_length=50)),
